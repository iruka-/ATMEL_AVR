...
#define	TCK			7			/* Target SCK */
#define	TDI			6			/* Target MISO */
#define	TDO			5			/* Target MOSI */
#define	TMS			4			/* Target RESET */
#define	ISP_IN		PINB
#define	JCMD_BITCOUNT_MASK	0x3f
#define	JCMD_INIT_TMS		0x40
#define	JCMD_LAST_TMS		0x80
...
void jtag_command()
{
	uchar *p = report.buf + 1;
	uchar *q = report.buf;
	uchar jcmd =*p++;				// jtag command
	uchar cnt;
	uchar bitcnt=0;
	uchar tdi_byte=0;
	uchar tdo_byte=0;
	uchar maxcnt=jcmd & JCMD_BITCOUNT_MASK;
