...
#define	VIDEO	0	//TV/ビデオ
#define	MUTE	0	//消音

#define	CUP		0	//Channel +
#define	CDN		0	//Channel -
#define	DISP	0	//画面表示.
#define	STIMER	0	//タイマー.


PROGMEM static uchar key_to_code[]={
//	PD0 	PD1 PD2	PD3	PD4	PD5	PD6	--			keycode
	EIZO,	VDN,3,	7,	11,	0,	0,		0,	// PB0	0-7
	VIDEO,	STD,2,	6,	10,	0,  0,		0,	// PB1	8-15
	MUTE,	CUP,1,	5,	9,	VDN,DISP,	0,	// PB2	16-23
	POWER,	VUP,CDN,4,  8,	12,	STIMER,	0,	// PB3	24-31
};
 ...
 **********************************************************************
 */ 
uchar set_code(uchar *buf,uchar maker_id,uchar key)
{
	uchar code_id = to_code(key);

	uchar idx = maker_id * 17 * 3;
	buf[0] = tbl(idx++);
	buf[1] = tbl(idx++);
	buf[2] = tbl(idx++);
