...
//	================================================================
//	user mode condition jumper definition for WSNAK #172 Board.
//	================================================================

#if	0
//	user_mode == CLOSE SLOW Jumper (USBasp)
#define	CONDITION_PORT		PORTC
#define	CONDITION_PIN		PINC
#define	CONDITION_JUMPER	2
//	boot_mode == OPEN  SLOW Jumper (USBasp)
/* True if jumper is not set */
#define bootLoaderCondition()   ((CONDITION_PIN & (1 << CONDITION_JUMPER)))  

#else

//	user_mode == OPEN GAME-'L' tact SW
#define	CONDITION_PORT		PORTD
#define	CONDITION_PIN		PIND
#define	CONDITION_JUMPER	5
//	boot_mode == CLOSE GAME-'L' tact SW
/* True if jumper is not set */
//#define bootLoaderCondition()   ((CONDITION_PIN & (1 << CONDITION_JUMPER)))  
#define bootLoaderCondition()   ((CONDITION_PIN & (1 << CONDITION_JUMPER))==0)  
...
{
    CONDITION_PORT = 1 << CONDITION_JUMPER; /* activate pull-up for key */
